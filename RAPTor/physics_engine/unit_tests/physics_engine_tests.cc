...
struct physics_engine_fixture : private boost::noncopyable
{
    ...
    :  collider(new rigid_body_collider(0.9, 0.75)),
       ...
       po3_check(new physics_object(make_cube(m, point_t(-0.5, -0.5, -0.5), point_t(0.5, 0.5, 0.5)), point_t(0.0, -7.4999925, 0.0), 10.0)),
       po4_check(new physics_object(make_cube(m, point_t(-0.5, -0.5, -0.5), point_t(0.5, 0.5, 0.5)), point_t(0.0, 11.0, 0.0), 10.0, 1)),
       po0(po0_check),
       po1(po1_check),
       po2(po2_check),
       po3(po3_check),
...
BOOST_AUTO_TEST_CASE( scene_to_triangles_test )
{
    ...
    BOOST_CHECK(tris->primitive( 0)->get_vertex_a() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 0)->get_vertex_b() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 0)->get_vertex_c() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 1)->get_vertex_a() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 1)->get_vertex_b() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 1)->get_vertex_c() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 2)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive( 2)->get_vertex_b() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive( 2)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 3)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive( 3)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 3)->get_vertex_c() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 4)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive( 4)->get_vertex_b() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 4)->get_vertex_c() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 5)->get_vertex_a() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 5)->get_vertex_b() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 5)->get_vertex_c() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 6)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 6)->get_vertex_b() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 6)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 7)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive( 7)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 7)->get_vertex_c() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive( 8)->get_vertex_a() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 8)->get_vertex_b() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 8)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 9)->get_vertex_a() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive( 9)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->primitive( 9)->get_vertex_c() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->primitive(10)->get_vertex_a() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive(10)->get_vertex_b() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive(10)->get_vertex_c() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive(11)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->primitive(11)->get_vertex_b() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->primitive(11)->get_vertex_c() == point_t(-0.5, -10.0,  0.5));

    BOOST_CHECK(tris->primitive(12)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(12)->get_vertex_b() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(12)->get_vertex_c() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(13)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(13)->get_vertex_b() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(13)->get_vertex_c() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(14)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(14)->get_vertex_b() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(14)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(15)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(15)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(15)->get_vertex_c() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(16)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(16)->get_vertex_b() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(16)->get_vertex_c() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(17)->get_vertex_a() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(17)->get_vertex_b() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(17)->get_vertex_c() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(18)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(18)->get_vertex_b() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(18)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(19)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(19)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(19)->get_vertex_c() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(20)->get_vertex_a() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(20)->get_vertex_b() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(20)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(21)->get_vertex_a() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(21)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->primitive(21)->get_vertex_c() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->primitive(22)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(22)->get_vertex_b() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(22)->get_vertex_c() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(23)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->primitive(23)->get_vertex_b() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->primitive(23)->get_vertex_c() == point_t(-0.5,  9.0,  0.5));
}
...
BOOST_AUTO_TEST_CASE( apply_force_test )
{
    ...
    BOOST_CHECK(uut.get_object(0)->get_force()  == point_t( 0.65, -2.25, 1.05));
    BOOST_CHECK(uut.get_object(1)->get_force()  == point_t(-3.3,   4.5,  0.1 ));
    BOOST_CHECK(uut.get_object(0)->get_torque() == point_t( 0.0,   0.0,  0.0 ));
...
BOOST_AUTO_TEST_CASE( apply_acceleration_test )
{
    ...
    uut.advance_time(0.5);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_force()    - point_t( 0.65,   -2.25,   1.05  ))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_force()    - point_t(-3.3,     4.5,    0.1   ))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_torque()   - point_t( 0.0,     0.0,    0.0   ))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_torque()   - point_t( 0.0,    -0.2,    9.0   ))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t( 0.0325, -0.1125, 0.0525))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(-0.165,   0.225,  0.005 ))) < result_tolerance);
}
...
BOOST_AUTO_TEST_CASE( advance_time_collide_test )
{
    ...
    uut.advance_time(0.5);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t(0.0, -9.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(0.0,  9.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t(0.0,  5.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(0.0, -5.0, 0.0))) < result_tolerance);

    uut.advance_time(0.6);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t(0.0,  4.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(0.0, -4.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t(0.0,  0.95, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(0.0, -0.95, 0.0))) < result_tolerance);
}
...
BOOST_AUTO_TEST_CASE( advance_time_three_way_collide_test )
{
    ...
    rigid_body_collider *const pc = new rigid_body_collider(0.0, 0.0);
    ...
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t(0.0, -9.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(0.0,  9.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(2)->get_velocity() - point_t(0.0, -9.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t(0.0,  5.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(0.0, -5.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(2)->get_center_of_mass() - point_t(0.0,  6.5, 0.0))) < result_tolerance);

    uut.advance_time(0.6);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t(0.0, -2.25, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(0.0, -4.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(2)->get_velocity() - point_t(0.0, -2.25, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t(0.0,  0.524812, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(0.0, -0.95, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(2)->get_center_of_mass() - point_t(0.0,  1.52556, 0.0))) < result_tolerance);
}
...
BOOST_AUTO_TEST_CASE( advance_time_rotating_past_test )
{
    ...
    uut.advance_time(0.5);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t( 1.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(-1.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t( 0.5,  9.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(-0.5, 11.0, 0.0))) < result_tolerance);

    uut.advance_time(0.5);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t( 1.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(-1.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t( 1.0,  9.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(-1.0, 11.0, 0.0))) < result_tolerance);
}
...
BOOST_AUTO_TEST_CASE( advance_time_rotating_in_plane_collide_and_slide_test )
{
    ...
    uut.advance_time(0.6);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_velocity() - point_t(0.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_velocity() - point_t(0.0, 0.0, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(0)->get_center_of_mass() - point_t(0.0,  0.5, 0.0))) < result_tolerance);
    BOOST_CHECK(fabs(magnitude(uut.get_object(1)->get_center_of_mass() - point_t(0.0, -0.5, 0.0))) < result_tolerance);
}
