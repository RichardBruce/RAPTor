...
BOOST_AUTO_TEST_CASE( scene_to_triangles_test )
{
    ...
    BOOST_CHECK(tris->at( 0)->get_vertex_b() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 0)->get_vertex_c() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 1)->get_vertex_a() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 1)->get_vertex_b() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 1)->get_vertex_c() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 2)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at( 2)->get_vertex_b() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at( 2)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 3)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at( 3)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 3)->get_vertex_c() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 4)->get_vertex_a() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at( 4)->get_vertex_b() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 4)->get_vertex_c() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 5)->get_vertex_a() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 5)->get_vertex_b() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 5)->get_vertex_c() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 6)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 6)->get_vertex_b() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 6)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 7)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at( 7)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 7)->get_vertex_c() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at( 8)->get_vertex_a() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 8)->get_vertex_b() == point_t(-0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 8)->get_vertex_c() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 9)->get_vertex_a() == point_t(-0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at( 9)->get_vertex_b() == point_t( 0.5,  -9.0,  0.5));
    BOOST_CHECK(tris->at( 9)->get_vertex_c() == point_t( 0.5,  -9.0, -0.5));
    BOOST_CHECK(tris->at(10)->get_vertex_a() == point_t(-0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at(10)->get_vertex_b() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at(10)->get_vertex_c() == point_t(-0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at(11)->get_vertex_a() == point_t( 0.5, -10.0, -0.5));
    BOOST_CHECK(tris->at(11)->get_vertex_b() == point_t( 0.5, -10.0,  0.5));
    BOOST_CHECK(tris->at(11)->get_vertex_c() == point_t(-0.5, -10.0,  0.5));

    BOOST_CHECK(tris->at(12)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(12)->get_vertex_b() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(12)->get_vertex_c() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(13)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(13)->get_vertex_b() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(13)->get_vertex_c() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(14)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(14)->get_vertex_b() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(14)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(15)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(15)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(15)->get_vertex_c() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(16)->get_vertex_a() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(16)->get_vertex_b() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(16)->get_vertex_c() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(17)->get_vertex_a() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(17)->get_vertex_b() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(17)->get_vertex_c() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(18)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(18)->get_vertex_b() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(18)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(19)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(19)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(19)->get_vertex_c() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(20)->get_vertex_a() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(20)->get_vertex_b() == point_t(-0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(20)->get_vertex_c() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(21)->get_vertex_a() == point_t(-0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(21)->get_vertex_b() == point_t( 0.5, 10.0,  0.5));
    BOOST_CHECK(tris->at(21)->get_vertex_c() == point_t( 0.5, 10.0, -0.5));
    BOOST_CHECK(tris->at(22)->get_vertex_a() == point_t(-0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(22)->get_vertex_b() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(22)->get_vertex_c() == point_t(-0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(23)->get_vertex_a() == point_t( 0.5,  9.0, -0.5));
    BOOST_CHECK(tris->at(23)->get_vertex_b() == point_t( 0.5,  9.0,  0.5));
    BOOST_CHECK(tris->at(23)->get_vertex_c() == point_t(-0.5,  9.0,  0.5));
