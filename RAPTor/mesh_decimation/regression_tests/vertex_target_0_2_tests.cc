...
struct mesh_decimation_regression_fixture : public regression_fixture
{
    mesh_decimation_regression_fixture() :
        // regression_fixture(mesh_decimation_options(1000.0f, 0.2f))
        regression_fixture(mesh_decimation_options(5000.0f, 270))
    {  }
};


BOOST_FIXTURE_TEST_SUITE( vertex_target_0_2_tests, mesh_decimation_regression_fixture )
