...
LIBPATH = $(LIBARYS_PATH)/SDL2-$(SDL_VER)/lib \
	...
	${BOOST_LIB_PATH}
SO_LIBS = SDL2 SDL2_ttf tbb tbbmalloc jpeg png boost_system boost_log boost_serialization
LIBRARY = $(SO_LIBS) fftw3f

# Defines
DEFINES = REFLECTIONS_ON REFRACTIONS_ON SIMD_PACKET_TRACING FRUSTRUM_CULLING SPATIAL_SUBDIVISION_BIH BOOST_LOG_DYN_LINK BOOST_LOG_LEVEL=boost::log::trivial::trace # THREADED_RAY_TRACE SPATIAL_SUBDIVISION_STATISTICS LOG_DEPTH SIMD_PACKET_TRACING FRUSTRUM_CULLING SHOW_KD_TREE DIFFUSE_REFLECTIONS=128.0 SOFT_SHADOW=256.0 
