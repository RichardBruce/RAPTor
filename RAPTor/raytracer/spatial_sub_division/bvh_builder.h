...
class bvh_builder
{
    public :
        ...
        bvh_builder(const float alpha = 0.4f, const float delta = 20.0f, const float max_leaf_sah_factor = 0.000007f, const int max_node_size = MAX_BVH_NODE_SIZE, const int max_down_phase_depth = 35) :
