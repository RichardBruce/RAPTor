...
class ray
{
    public :
        ...
        ray(point_t o, float x = 0.0f, float y = 0.0f, float z = 0.0f, float m = 1.0f, int c = 1) : 
        ...
        ray(point_t o, point_t d, float m = 1.0f, int c = 1) : 
        ...
        /* Access functions */
        void set_up(point_t o, float x = 0.0f, float y = 0.0f, float z = 0.0f, float m = 1.0f, int c = 1)
        {
            this->ogn       = o;
        ...
        void set_up(point_t o, point_t d, float m = 1.0f, int c = 1)
        {
            this->dst       = d;
            this->ogn       = o;
            this->magn      = m;
