...
class ext_colour_t
{
    public :
        fp_t r,g,b;
        ext_colour_t(const fp_t r, const fp_t g, const fp_t b) : r(r), g(g), b(b) { };
        ext_colour_t(const fp_t r = 0.0) : r(r), g(r), b(r) { };

        inline const bool          operator==(const ext_colour_t &rhs)  const   { return ((this->r == rhs.r) && (this->g == rhs.g) && (this->b == rhs.b));  }
        inline const bool          operator!=(const ext_colour_t &rhs)  const   { return ((this->r != rhs.r) || (this->g != rhs.g) || (this->b != rhs.b));  }

        inline const ext_colour_t& operator+=(const fp_t rhs)                   { this->r += rhs;   this->g += rhs;   this->b += rhs;   return *this;       }
        inline const ext_colour_t& operator-=(const fp_t rhs)                   { this->r -= rhs;   this->g -= rhs;   this->b -= rhs;   return *this;       }
        inline const ext_colour_t& operator*=(const fp_t rhs)                   { this->r *= rhs;   this->g *= rhs;   this->b *= rhs;   return *this;       }
        inline const ext_colour_t& operator/=(const fp_t rhs)                   { this->r /= rhs;   this->g /= rhs;   this->b /= rhs;   return *this;       }
...
inline const ext_colour_t operator+(const ext_colour_t &lhs, const fp_t rhs)
{
...
*****************************************************/
inline fp_t magnitude(const ext_colour_t &a)
{
