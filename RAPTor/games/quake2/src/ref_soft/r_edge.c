...
if (s->insubmodel)
{
    ...
    {
        int lindex = r_worldmodel->surfedges[pface->firstedge + i];
...
//        float verts[3] = {
//            r_worldmodel->vertexes[r_worldmodel->edges[lindex].v[vert]].position[0],
//            r_worldmodel->vertexes[r_worldmodel->edges[lindex].v[vert]].position[1],
//            r_worldmodel->vertexes[r_worldmodel->edges[lindex].v[vert]].position[2]
//        };

        VectorSubtract (r_worldmodel->vertexes[r_worldmodel->edges[lindex].v[vert]].position,
                        r_origin,
                        local);
