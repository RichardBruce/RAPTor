...
// draw triangles
	for (i=1 ; i<k-1 ; i++)
	{
        ...
        {
            float local[3][3];
            local[0][0] =  aliastriangleparms.a->xyz[0];
            local[0][1] = -aliastriangleparms.b->xyz[1];
            local[0][2] =  aliastriangleparms.c->xyz[2];
            local[1][0] =  aliastriangleparms.a->xyz[0];
            local[1][1] = -aliastriangleparms.b->xyz[1];
            local[1][2] =  aliastriangleparms.c->xyz[2];
            local[2][0] =  aliastriangleparms.a->xyz[0];
            local[2][1] = -aliastriangleparms.b->xyz[1];
            local[2][2] =  aliastriangleparms.c->xyz[2];

            raptor_push_triangle(local[0], local[1], local[2], 0, 0, 0, 0, 0);
        }
#else
		R_DrawTriangle();
#endif
