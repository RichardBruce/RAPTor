...
#ifdef RAPTOR_RAYTRACE
        if (num_light_triangles_pushed)
        {
            VectorScale(centre, 1.0f/(num_light_triangles_pushed*3.0f), centre); // Get centre of light
            raptor_create_triangle_light((1.0f-scale)*BONUS_ITEM_LIGHT_RED, (1.0f-scale)*BONUS_ITEM_LIGHT_GREEN, (1.0f-scale)*BONUS_ITEM_LIGHT_BLUE, BONUS_ITEM_LIGHT_FALLOFF, centre);
        }
#endif//RAPTOR_RAYTRACE
	}
}
